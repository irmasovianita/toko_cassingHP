...
if(isset($_GET['open'])) {
	switch ($_GET['open']){
		...
		case 'Pencarian-Barang' :if(!file_exists ("pencarian_barang.php")) die ("File cari barang tidak ada"); 
		...
		case 'Barang-Kategori' :if(!file_exists ("barang_kategori.php")) die ("File barang tidak ada"); 
		...
		case 'Konfirmasi' :if(!file_exists ("konfirmasi.php")) die ("File konfirmasi transaksi tidak ada"); 
