...
if($_GET) {
	switch ($_GET['open']){				
		...
		case 'Laporan' :	
			...
			case 'Laporan-Pemesanan-Lunas-Harian' :				
				if(!file_exists ("laporan_pemesanan_lunas_harian.php")) die ("Sorry Empty Page!"); 
				include "laporan_pemesanan_lunas_harian.php"; break;			
