...
<table class="table-list" width="750" border="0" cellspacing="1" cellpadding="3">
  <tr>
    <th width="20" align="center" bgcolor="#CCCCCC"><b>No</b></th>
    <th width="62" bgcolor="#CCCCCC"><b>Tanggal</b></th>
    <th width="75" bgcolor="#CCCCCC"><b>Kode Plg </b></th>
    <th width="247" bgcolor="#CCCCCC"><strong>Nama Pelanggan </strong></th>
    <th width="82" align="right" bgcolor="#CCCCCC">Total Brang </th>
    <th width="120" align="right" bgcolor="#CCCCCC"><b>Total  Bayar (Rp) </b></th>
    <th width="50" align="right" bgcolor="#CCCCCC"><strong>Status </strong></th>
    <td width="37" align="center" bgcolor="#CCCCCC"><b>Tools</b></td>
  </tr>
	<?php
  ...
  <tr>
    ...
    <td><?php echo format_angka($unikTransfer); ?></td>
    <td bgcolor="#FFFFCC"><?php echo $myData['status_bayar']; ?></td>
    <td><a href="pemesanan_lihat.php?Kode=<?php echo $Kode; ?>" target="_blank" class='button white small'>Lihat</a></td>
  </tr>
  <?php } ?>
</table>
</body>
