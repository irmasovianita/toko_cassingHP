...
<title>Cetak Pemesanan Lengkap</title>
</head>
<body>
...
<table width="550" border="0" cellspacing="2" cellpadding="3">
  ...
  <tr>
    <td width="33%"><strong>No. Pemesanan</strong></td>
    <td width="2%">:</td>
    <td width="65%"> <?php echo $myData['no_pemesanan']; ?> </td>
  </tr>
  <tr>
  ...
  <tr>
    <td><strong>Kode Unik Transfer </strong></td>
    <td>:</td>
  ...
  <tr>
    <td bgcolor="#FFFF99"><strong>Status Pembayaran </strong></td>
    <td>:</td>
...
<table width="750" border="0" cellpadding="2" cellspacing="0" class="table-list">
  <tr>
    ...
    <td width="54" bgcolor="#CCCCCC"><b>Jumlah</b></td>
